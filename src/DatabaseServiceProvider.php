...
class DatabaseServiceProvider extends AbstractServiceProvider
{
    ...
    protected function registerConnectionServices()
    {
        ...
        $this->getContainer()->singleton('db.factory', ConnectionFactory::class);

        // The database manager is used to resolve various connections, since multiple
        // connections might be managed. It also implements the connection resolver
        // interface which may be used by other components requiring connections.
        $this->getContainer()->singleton('db', DatabaseManager::class);
//            ->withArgument(ApplicationInterface::class)
//            ->withArgument(ConnectionFactory::class);

        $this->getContainer()->singleton('db.connection', function () {
