...
class TestUtil
{
    ...
    public static function getConnection(): Connection
    {
        ...
        $conn = static::createConnection(self::getConnectionParams());
    ...
    private static function initializeDatabase(): void
    {
        ...
        $testConn = static::createConnection($testConnParams);

        // Connect as a privileged user to create and drop the test database.
        $privConn = static::createConnection($privConnParams);
    ...
    {
        return static::createConnection(self::getPrivilegedConnectionParameters());
    }
    ...
    protected static function createConnection($params): Connection
    {
        return (new ConnectionFactory())->make($params);
    }
}
